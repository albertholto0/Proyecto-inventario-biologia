        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <ul>
                        <li><strong>Nombre:</strong> Microscopio A</li>
                        <li><strong>Grupo:</strong> Grupo 1</li>
                        <li><strong>Categoría:</strong> Categoría 1</li>
                        <li><strong>Subcategoría:</strong> Subcat 1</li>
                        <li><strong>Tipo:</strong> Tipo 1</li>
                        <li><strong>Marca:</strong> Leica</li>
                        <li><strong>Modelo:</strong> DM500</li>
                        <li><strong>Serie:</strong> SN12345</li>
                        <li><strong>Color:</strong> Blanco</li>
                        <li><strong>Precio:</strong> $12,000.00</li>
                        <li><strong>Laboratorio:</strong> Lab 1</li>
                        <li><strong>Estado Físico:</strong> Bueno</li>
                    </ul>
                </div>
                <div class="modal-footer">
